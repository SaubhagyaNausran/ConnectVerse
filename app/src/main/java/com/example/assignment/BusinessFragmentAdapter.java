...
public class BusinessFragmentAdapter  extends RecyclerView.Adapter<BusinessFragmentAdapter.MyViewHolder>{

    Context context;
    ArrayList<itemsofcardview> itemsofcardviewArrayList;
    public BusinessFragmentAdapter(Context context, ArrayList<itemsofcardview> itemsofcardviewArrayList) {
    ...
    @NonNull
    @Override
    public BusinessFragmentAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View  v= LayoutInflater.from(context).inflate(R.layout.cardviewpersonal,parent,false);
        return new BusinessFragmentAdapter.MyViewHolder(v);
    }


    @Override
    public void onBindViewHolder(@NonNull BusinessFragmentAdapter.MyViewHolder holder, int position) {
