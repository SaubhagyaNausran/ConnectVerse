...
public class PersonalFragmentAdapter extends RecyclerView.Adapter<PersonalFragmentAdapter.MyViewHolder> {

    Context context;
    ArrayList<itemsofcardview> itemsofcardviewArrayList;
    public PersonalFragmentAdapter(Context context, ArrayList<itemsofcardview> itemsofcardviewArrayList) {
